...
namespace AllPaczkinoPersistance.Migrations
{
    ...
    [Migration("20240318183507_parcelsdb")]
    partial class parcelsdb
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AllPaczkinoPersistance.Models.ParcelDb", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("ReceiverLockerId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("ReceiverLockerId");

                    b.HasIndex("SenderId");

                    b.HasIndex("SenderLockerId");
            ...
            modelBuilder.Entity("AllPaczkinoPersistance.Models.ParcelDb", b =>
                {
                    ...
                    b.HasOne("AllPaczkino.Models.ParcelLockerDb", "ReceiverLocker")
                        .WithMany()
                        .HasForeignKey("ReceiverLockerId")
                    ...
                    b.HasOne("AllPaczkino.Models.ParcelLockerDb", "SenderLocker")
                        .WithMany()
                        .HasForeignKey("SenderLockerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.OwnsOne("Parcels.Parcels.ParcelSize", "ParcelSize", b1 =>
                        {
                            b1.Property<int>("ParcelDbID")
                                .HasColumnType("int");

                            b1.Property<string>("Name")
                                .HasColumnType("nvarchar(max)");

                            b1.HasKey("ParcelDbID");

                            b1.ToTable("Parcels");

                            b1.WithOwner()
                                .HasForeignKey("ParcelDbID");
                        });
                    ...
                    b.Navigation("ReceiverLocker");

                    b.Navigation("Sender");

                    b.Navigation("SenderLocker");
                });
